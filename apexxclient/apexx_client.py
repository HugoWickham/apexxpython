...
def createCardTransaction(X_APIKEY, amount, capture_now, merchant_reference, customer_ip, user_agent, cvv=None,
    ...
    headers = apexx_utils.createHeaders(X_APIKEY, Content_Type)

    payload = apexx_utils.createCardTransactionPayload(amount, capture_now, merchant_reference, card_number, cvv, expiry_month,
                                           expiry_year,
...
def refundCardTransaction(transactionID, X_APIKEY, amount, reason=None, merchant_refund_reference=None,
    ...
    payload = apexx_utils.refundCardTransactionPayload(amount, reason, merchant_refund_reference, refund_time)
...
def hostedPaymentPage(X_APIKEY, amount, capture_now, merchant_reference, return_url, locale, account=None,
    ...
    payload = apexx_utils.hostedPaymentPagePayload(amount, capture_now, merchant_reference, return_url, locale, account,
...
def captureCardTransaction(amount, capture_reference, transactionID, X_APIKEY, Content_Type="application/json"):
    ...
    payload = apexx_utils.captureCardTransactionPayload(amount, capture_reference)
...
def cancelCardTransaction(transactionID, X_APIKEY, cancel_time=None, Content_Type="application/json"):
    ...
    payload = apexx_utils.cancelCardTransactionPayload(cancel_time)
